...
SLCs <- subset(datExprdf3, grepl("0006561", GOTerms))
...
The data in the plot above is only a small sample of the data from [Ferreiro et al.](https://www.ncbi.nlm.nih.gov/pubmed/20187982). To be able to access all of the data, I wrote an interactive app that allows to query [gene ontology terms](http://geneontology.org/). Each gene ontology term is represented by the boxplot and individual genes are represented as circles.
