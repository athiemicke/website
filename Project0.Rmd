...
When cells are exposed to increased levels of NaCl, they change their gene expression. For example GO term #0007049 classifies genes associated with the cell cycle. Each gene ontology term is represented by the boxplot and individual genes are represented as circles:
...
The data in the plot above is only a small sample of the data from [Ferreiro et al.](https://www.ncbi.nlm.nih.gov/pubmed/20187982). To be able to access all of the data, I wrote an interactive app that allows to query [gene ontology terms](http://geneontology.org/). 
